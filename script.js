...
function dodgeButton(event) {
    ...
    // 6 FIXED SPOTS batay sa mga asul na bilog mo (Kalkulado mula sa gitna ng button container)
    const spots = [
        { x: -120, y: -260 }, // Spot 1: Top-Left
        { x: 0,    y: -260 }, // Spot 2: Top-Center
        { x: 120,  y: -260 }, // Spot 3: Top-Right
        { x: -120, y: 140  }, // Spot 4: Bottom-Left
        { x: 0,    y: 140  }, // Spot 5: Bottom-Center
        { x: 120,  y: 140  }  // Spot 6: Bottom-Right
    ];
